...
// Cargar los datos
    public function LoadData($courses)
    {
        $data = array();
    ...
    // Tabla coloreada
    public function HeaderTable($period, $groupA, $groupB)
    {
    ...
    public function Period($arrayI, $arrayII, $period)
    {
...
foreach ($students as $student) {
    ...
    switch ($period) {
        case 1:
            $pdf->Cell(0, 0, utf8_decode("                                       MATRÍCULA I SEMESTRE - II NIVEL  " . $year));
            break;
        case 2:
            $pdf->Cell(0, 0, utf8_decode("                                       MATRÍCULA II SEMESTRE - II NIVEL  " . $year));
            break;
        case 3:
            $pdf->Cell(0, 0, utf8_decode("                                       MATRÍCULA I SEMESTRE - III NIVEL  " . $year));
            break;
        case 4:
            $pdf->Cell(0, 0, utf8_decode("                                       MATRÍCULA II SEMESTRE - III NIVEL  " . $year));
            break;
        default:
            break;
    }
