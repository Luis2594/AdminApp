...
// Cargar los datos
    ...
    function Period() {
        ...
        $data = array(
            ...
            array("33", "Módulo basico de español", 1),
            array("33", "Módulo basico de español", 2),
            array("33", "Módulo basico de español", 2),
            array("32", "Propiedades de la materia y sus aplicaciones en la industria y la vida cotidiana ", 2),
            array("34", "Ingles para todos", 2),
            array("34", "Ingles para todos", 1),
            array("34", "Ingles para todos", 1),
            array("35", "Cotidianidad del ser humano: desde sus orígenes hasta el siglo XVIII", 1)
        );
