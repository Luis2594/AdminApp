...
<section class="content-header" style="text-align: left">
    <ol class="breadcrumb">
        ...
        <li><a href="CreateNotificationAdmin.php"><i class="fa fa-arrow-circle-right"></i> Crear Notificación Administradores</a></li>
    </ol>
</section>
<br>
        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Enviar Notificación Administradores</h3>
                </div><!-- /.box-header -->
