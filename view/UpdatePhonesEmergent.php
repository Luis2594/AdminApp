        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form role="form" id="f"  method="POST" action="../business/CreatePhoneEmergentAction.php?id=<?php echo $id; ?>">
                        <div class="box-body">
                                        ...
                                        <td>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input readonly="" type="number" class="form-control" value="<?php echo $phone->getPhone(); ?>" />
                                                </div><!-- /.input group -->
                                            </div><!-- /.form group -->
                                        </td>
                                        <td>
                                            <div class="btn-group-vertical"style="margin-top: 9px; margin-left: 15px;">
                                                <button  type="button" onclick="deletePhonePerson(<?php echo $id; ?>,<?php echo $phone->getPk(); ?>);" class="btn btn-danger">Eliminar</button>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
...
<script type="text/javascript">
    ...
    function deletePhonePerson(idPerson, idPhoneDelete) {
        window.location = "../business/DeletePhoneEmergentAction.php?idPerson=" + idPerson + "&idPhone=" + idPhoneDelete;
    }
