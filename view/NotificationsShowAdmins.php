                    ...
                    <table id="tablaNotificaciones" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                ...
                                $notifications = $notificationBusiness->getAllAdminsNotifications();
...
<script type="text/javascript">
    ...
    function update(id) {
        window.location = "NotificationsUpdateAdmin.php?id=" + id;
    }

    function remove(id) {
        alertify.confirm('Eliminar Registro', '¿Desea eliminar?', function () {
                    window.location = "../business/NotificationsDeleteAdminAction.php?id=" + id;
                }
        , function () {
