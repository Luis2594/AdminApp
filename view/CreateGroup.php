...
<section class="content-header" style="text-align: left">
    <ol class="breadcrumb">
        ...
        <li><a href="CreateGroup.php"><i class="fa fa-arrow-circle-right"></i>Crear Grupo</a></li>
    </ol>
</section>
<br>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" id="formGroup" action="../actions/GroupCreateAction.php" method="POST" enctype="multipart/form-data">
                    <div class="box-body">
