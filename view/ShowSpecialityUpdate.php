...
<section class="content-header" style="text-align: left">
    <ol class="breadcrumb">
        ...
        <li><a href="ShowSpecialityUpdate.php"><i class="fa fa-arrow-circle-right"></i> Actualizar Especialidades</a></li>
    </ol>
</section>
<br>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Actualizar Especialidades del Cindea</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
