...
<section class="content-header" style="text-align: left">
    <ol class="breadcrumb">
        ...
        <li><a href="NotificationsShowAdmins.php"><i class="fa fa-arrow-circle-right"></i> Notificaciones</a></li>
        <li><a href="#"><i class="fa fa-arrow-circle-right"></i>Actualizar Notificación Administradores</a></li>
    </ol>
</section>
<br>
        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Actualizar Notificación Administradores</h3>
                </div><!-- /.box-header -->
                ...
                $id = $_GET['id'];
                $notifications = $notificationBusiness->getNotificationAdmin($id);
                foreach ($notifications as $notification) {
                    ?>
                    <!-- form start -->
                    <form role="form" id="formNotification" action="../business/NotificationsUpdateAdminAction.php" method="POST" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    function backPage() {
        window.location = "NotificationsShowAdmins.php";
    }
</script>
