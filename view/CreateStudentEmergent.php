...
<section class="content-header" style="text-align: left">
    <ol class="breadcrumb">
        ...
        <li><a href="CreateStudentEmergent.php"><i class="fa fa-arrow-circle-right"></i>Crear Estudiante Emergente</a></li>
    </ol>
</section>
<br>
        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Crear Estudiante Emergente</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" id="formStudent" action="../business/CreateStudentEmergentAction.php" method="POST" enctype="multipart/form-data">
                    <div class="box-body">
                        <!--DNI-->
